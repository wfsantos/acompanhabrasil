-- ==============================================================================
-- Esquema de Banco de Dados — AcompanhaBrasil
-- Compatível com SQLite e PostgreSQL
-- ==============================================================================

-- Tabela de Seções Eleitorais Auditadas
CREATE TABLE IF NOT EXISTS secoes_eleitorais (
    ...
    status_auditoria VARCHAR(20) DEFAULT 'AGUARDANDO', -- AGUARDANDO, VALIDADO, DIVERGENTE
...
-- Tabela de Submissões de Boletins de Urna (BUs)
CREATE TABLE IF NOT EXISTS boletins (
    ...
    status_validacao VARCHAR(30) DEFAULT 'VALIDO', -- VALIDO, INCONSISTENTE_MATEMATICO, DIVERGENTE
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY(secao_id) REFERENCES secoes_eleitorais(id) ON DELETE CASCADE
);

-- Tabela de Detalhamento de Votos por Candidato / Cargo
